 ...
 */
@Entity
@Table(name = "vocabulario", catalog = "planeacion", schema = "public", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"palabra"})})
@NamedQueries({
...
public class Vocabulario implements Serializable {
    ...
    @Size(max = 2147483647)
    @Column(name = "palabra", length = 2147483647)
    ...
    public String toString() {
        return "entidad.Vocabulario[ idPalabra=" + idPalabra + " ]";
    }
